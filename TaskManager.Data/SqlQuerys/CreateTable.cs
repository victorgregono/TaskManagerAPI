namespace TaskManager.Data.SqlQuerys
{
    ...
    {
        public const string CreateUsuarioTable = @"
        ...
        public const string CreateProjetoTable = @"
        ...
        public const string CreateTarefaTable = @"
        ...
        public const string CreateComentarioTable = @"
        ...
        public const string CreateHistoricoTarefaTable = @"
        ...
        public const string DropHistoricoTarefaTable = "DROP TABLE IF EXISTS HistoricoTarefa;";
        public const string DropComentarioTable = "DROP TABLE IF EXISTS Comentario;";
        public const string DropTarefaTable = "DROP TABLE IF EXISTS Tarefa;";
        public const string DropProjetoTable = "DROP TABLE IF EXISTS Projeto;";
        public const string DropUsuarioTable = "DROP TABLE IF EXISTS Usuario;";

        public const string InsertFakeData = @"
